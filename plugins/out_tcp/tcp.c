                         ...
                         struct flb_config *config)
{
    ...
    flb_plg_debug(ctx->ins, "\tcb_tcp_flush start write");
    ...
    flb_plg_debug(ctx->ins, "\tcb_tcp_flush write finished");
    ...
    flb_plg_debug(ctx->ins, "\t\tcb_tcp_flush before conn_release u(%p) ka_count(%d)", ctx->u, u_conn->ka_count);
    flb_upstream_conn_release(u_conn);
